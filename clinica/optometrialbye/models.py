...
class Pacientes(models.Model):
    ...
    celular_regex = RegexValidator(regex=r'^\+?549?\d{8}$', message = "Número debe ser ingresado en formato '+549XXXXXXXXXX'.")
    ...
    def get_absolute_url(self):
        ...
        return reverse ('model-detail-view', args=[str(self.run)])
    def __str__(self):
